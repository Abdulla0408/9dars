...
urlpatterns = [
    ...
    path('export-quiz/<int:quiz_id>/', views.export_quiz_answers, name='export_quiz_answers'),
    path('generate-quiz-pdf/<int:quiz_id>/', views.generate_quiz_pdf, name='generate_quiz_pdf'),
]